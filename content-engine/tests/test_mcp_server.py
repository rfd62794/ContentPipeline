...
class TestGetContentRecommendations:
    ...
    def test_get_content_recommendations_default(self):
        ...
        mock_game1 = GameMetrics(
            ...
            content_demand_score=3.0, composite_score=2.8, actual_playtime_hours=None, genres=['Action'], last_played=None
        )
        mock_game2 = GameMetrics(
            ...
            content_demand_score=2.699, composite_score=2.3, actual_playtime_hours=None, genres=['RPG'], last_played=None
        )
        mock_client.get_game_metrics.return_value = [mock_game1, mock_game2]
