#!/usr/bin/env python3
"""
Upload specific shorts to YouTube with Zira VO versions.
"""
...
def main():
    ...
    logger.info(f"Uploading {len(SHORT_IDS)} specific shorts")
    ...
    # Save results
    with open("specific_upload_results.json", "w") as f:
